...
while True:
    if ai_mode == "basic":
        ...
        elif user_please == "モジュールモード" or user_please == "ライブラリモード":
            print("わかりました。ではモジュール・ライブラリモードに移行します。")
            ai_mode = "module"
            print("モジュールモードでは、importでいくつも使えるモジュールについて提供します。")
            print("知りたいモジュールのキーワードを入力してください。(time, os, math etc...):")
        else:
        ...
        if user_module in user_finish:
            ...
            print("例: import subprocess")
            print("使い方： import subprocess")
        elif user_module == "基本コードモード":
            print("わかりました。では基本コードモードに戻ります")
            ai_mode = "basic"
            print("Pythonで多用する基本コード復習用のAIです。知りたいコードのキーワードを入力してください。(print, input, import etc...)")
        elif user_module == "補助系コードモード":
            print("わかりました。では補助系コードモードに移行します")
            ai_mode = "auxiliary"
            print("補助系コードモードでは、特定のタスクに対するコードの雛形を提供します。")
            print("知りたいタスクのキーワードを入力してください。(break continue etc...)")
        elif user_module == "詳細説明モード":
            print("わかりました。では詳細説明モードに移行します")
            ai_mode = "detailed"
            print("詳細説明モードでは、特定のコードに対する詳細な説明を提供します。")
            print("知りたいコードのキーワードを入力してください。")
